  ...
  return (
    <section id="about" className="about-section">
      <div className="container row ml-0">
        ...
        {/* Left Heading */}
        <div className="col-md-4 mt-4 mb-4 mb-md-0 about-heading-wrapper">
          <h2 className="about-heading">ABOUT ME</h2>
        </div>
        
        {/* Right Card */}
        <div className="col-md-8 text-center mt-3 mb-4 mb-md-0">
          <Fade direction="right" triggerOnce easing="ease-in-out">
            <div className="about-card p-5">
              <h3 className="about-name">GOURI<br />GUPTA</h3>
              <p className="about-description mt-4">
                I’m a software developer with a background in content strategy. 
                After years of guiding narratives, I’m now deeply immersed in coding. 
